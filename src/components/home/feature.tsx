        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={5}>
            <Box sx={{ position: 'relative' }}>
              <Image src="/images/big-img.svg" width={750} height={700} alt="Feature img" />
            </Box>
          </Grid>
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Choose the way of learning according to your wishes, enjoy the practice of speaking on current topics, learn in your own pace.
            </Typography>
